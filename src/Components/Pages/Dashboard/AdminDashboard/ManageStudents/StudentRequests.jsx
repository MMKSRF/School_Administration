// src/Components/Pages/Dashboard/AdminDashboard/ManageStudents/StudentRequests.jsx
import React, { useEffect, useRef, useState } from 'react';
import { gsap } from 'gsap';
import { useSelector, useDispatch } from 'react-redux';
import { fetchStudentRequests, respondToRequest } from '../../../../../Redux/Slices/studentsSlice';
import { FaClock, FaCheck, FaTimes, FaSearch, FaFilter } from 'react-icons/fa';
import { FiChevronDown, FiChevronUp } from 'react-icons/fi';

const StudentRequests = () => {
  const dispatch = useDispatch();
  const { requests, status, error } = useSelector(state => state.students);
  ...
  return (
    <div ref={containerRef} className="bg-white rounded-2xl shadow-xl p-6">
      <h2 className="text-2xl font-bold text-gray-900 mb-6">Student Requests</h2>
      ...
      <div className="mb-6">
        <div className="flex flex-col md:flex-row gap-3">
          <div className="relative flex-1">
            ...
            <input
              type="text"
              placeholder="Search requests by student or type..."
              value={searchTerm}
