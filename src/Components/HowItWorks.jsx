...
//     gsap.fromTo(sectionRef.current.querySelectorAll('.step'),{
//         opacity: 0
//     }, {
//       duration: 0.8,
//       opacity: 100,
...
//         <div className="relative max-w-4xl mx-auto">
//           {/* Timeline line */}
//           <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-blue-200 top-0 hidden md:block"></div>
          
//           <div className="space-y-12">
//             {steps.map((step, index) => (
//               <div 
//                 key={index}
//                 className="step relative flex flex-col md:flex-row items-center"
//               >
//                 <div className="flex-shrink-0 z-10 flex items-center justify-center w-16 h-16 rounded-full bg-blue-600 text-white text-xl font-bold mb-4 md:mb-0">
//                   {index + 1}
//                 </div>
...
//                 </div>
//                 <div className="hidden md:block md:w-5/12"></div> {/* Spacer for timeline */}
//               </div>
//             ))}
//           </div>
//         </div>
